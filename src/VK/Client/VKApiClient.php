...
class VKApiClient {
     ...
     */
    public function __construct(string $api_version = self::API_VERSION, ?string $language = null, ?string $host = self::API_HOST) {
        $this->request = new VKApiRequest($api_version, $language, $host);
    }
